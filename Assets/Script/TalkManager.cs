...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        talkData.Add(20, new string[] { ".zzZ... :1" });
        ...
        talkData.Add(1100, new string[] { "(???)의 구체를 획득하였다!:0","Key Z를 눌러 구체 활성화:0"});

        // Quset Data

        talkData.Add(10 + 20, new string[] { "..... :0", "배가 고프다냥...:0", "zzZ... :1" });
        talkData.Add(11 + 20, new string[] { "...? :0", "고기다냥!:0" });
        talkData.Add(12 + 20, new string[] { "이건 선물이다냥!:0" });
        talkData.Add(13 + 20, new string[] { "..... :0", "세상을... :0", "구해야 한다냥... :0", "zzZ... :1" });

        talkData.Add(20 + 30, new string[] { "이 밑으로 가고 싶으면 열쇠를 3개 구해오는거다냥:0"," 먼저 이 위로 가보는게 좋아보인다냥:1" });
        ...
        portraitData.Add(30 + 0, portraitArr[2]);
        portraitData.Add(30 + 1, portraitArr[3]);
